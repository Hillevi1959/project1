...
export default {
  ...
  cartMealProductIcon: Selector('[data-testid="meal-ProductIcon"]'),
  ...
  payInternalPaymentMethod: Selector('[data-testid="payment-notification-zeroAmountCart"]'),
  postBookingPage: Selector('#extraProductsForm'),
  priceSummayPrice: Selector(
    '[data-testid="payment-bottomContent-priceSummary"]>div span:nth-child(2)',
  ),
